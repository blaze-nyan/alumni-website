          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h1 className="text-3xl md:text-5xl font-bold tracking-tighter">
                Welcome to the RIC Alumni Network
              </h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-4 max-w-[700px] mx-auto">
              Discover the benefits of being part of our growing alumni
              community
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Build your professional network with graduates from various
                  years and fields.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Inspire others with your achievements and career milestones.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Participate in reunions, workshops, and networking events.
                </p>
              </CardContent>
            </Card>
          </div>
