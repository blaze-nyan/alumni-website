...
export default function CreateStoryPage() {
  ...
  const handleImagesChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    Promise.all(
      files.map(
        (file) =>
          new Promise<{ dataType: string; base64data: string }>(
            (resolve, reject) => {
    ...
    <div className="container flex justify-center py-12">
      <Card className="w-full max-w-2xl">
        ...
        <Alert className="mx-6 mb-4">
          ...
          <AlertDescription>
            Your story will be submitted for admin review before being
            published. You'll be notified once it's approved.
          </AlertDescription>
        </Alert>
